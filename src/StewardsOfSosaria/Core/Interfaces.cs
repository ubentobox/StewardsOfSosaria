...
public interface ITaskService
{
    ...
    bool ResolveDependencies(TownTask task, IReadOnlyDictionary<Guid, TownTaskStatus> statusByTaskId);
    IReadOnlyList<ReservationToken> ExpireReservations(DateTime nowUtc);
}
